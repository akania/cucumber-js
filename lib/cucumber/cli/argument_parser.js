var ArgumentParser = function(argv) {
  ...
  var self = {
    ...
    getStepTimeout: function getStepTimeout() {
      var getStepTimeout = self.getOptionOrDefault(ArgumentParser.TIMEOUT_FLAG_NAME, ArgumentParser.DEFAULT_TIMEOUT_FLAG_VALUE);
    ...
    getKnownOptionDefinitions: function getKnownOptionDefinitions() {
      ...
      definitions[ArgumentParser.TIMEOUT_FLAG_NAME]                = Number;
    ...
    getShortenedOptionDefinitions: function getShortenedOptionDefinitions() {
      ...
      definitions[ArgumentParser.TIMEOUT_FLAG_SHORT_NAME] = [ArgumentParser.LONG_OPTION_PREFIX + ArgumentParser.TIMEOUT_FLAG_NAME];
      return definitions;
    },
...
ArgumentParser.TIMEOUT_FLAG_NAME                         = "timeout";
ArgumentParser.TIMEOUT_FLAG_SHORT_NAME                   = "t";
ArgumentParser.DEFAULT_TIMEOUT_FLAG_VALUE                = 30000;
